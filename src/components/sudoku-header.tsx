...
export function SudokuHeader({ timer, formatTime, difficulty, onDifficultyChange, onStartTour }: SudokuHeaderProps) {
  return (
    <div className="flex items-center justify-between w-full">
      ...
      <Tabs value={difficulty} onValueChange={(value) => onDifficultyChange(value as Difficulty)} id="difficulty-tabs">
        <TabsList>
